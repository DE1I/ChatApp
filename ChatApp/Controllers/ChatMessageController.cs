...
namespace ChatApp.Controllers
{
    ...
    {
        public IActionResult DashBoard() // This method is an action method in the ChatMessageController class. It handles HTTP requests to the /ChatMessage/Index URL (or simply /ChatMessage if Index is the default action).
        {
